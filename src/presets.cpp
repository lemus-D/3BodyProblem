...
const PresetConfig presets[] = {
    {"Figure-8 Orbit",
     "Three equal masses trace a figure-8 pattern - a rare stable periodic solution",
     3,
     1.0,
     {{-0.97000436, 0.24308753, 0.466203685, 0.43236573, 1.0},
      ...
      {0.97000436, -0.24308753, 0.466203685, 0.43236573, 1.0}}},
    {"Binary Star + Planet",
     "Two heavy stars orbit each other while a light planet dances chaotically around them",
     3,
     1.0,
     {
    ...
    {"Mini Solar System",
     "One massive sun with three planets in stable orbits at different distances",
     4,
     1.0,
     {
         ...
         {4.0, 0.0, 0.0, 0.52, 0.5}  // Outer planet
     }},
    {"Chaotic Butterfly",
     "Four bodies in a high-energy configuration that creates beautiful chaotic patterns",
     4,
     1.0,
     {{-1.0, -1.0, 0.3, 0.3, 1.0},
      {1.0, -1.0, -0.3, 0.3, 1.0},
      ...
      {1.0, 1.0, -0.3, -0.3, 1.0}}},
    {"Lagrange Triangle",
     "Three equal masses form a rotating equilateral triangle - perfectly stable!",
     3,
     1.0,
     {
    ...
    {"Pyth Three-Body",
     "Three unequal masses (3-4-5 ratio) in a figure-8 like pattern",
     3,
     1.0,
